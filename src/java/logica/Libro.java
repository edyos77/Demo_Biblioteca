...
public class Libro {
    ...
    public Libro(String isbn, String nombre, int numeroDePaginas, int annio, int idCategoria, String codigoAutor) {
        this.isbn = isbn;
        this.nombre = nombre;
    ...
    public String toString() {
        return "Libro{" + "isbn=" + isbn + ", nombre=" + nombre + ", numeroDePaginas=" + numeroDePaginas + ", annio=" + annio + ", idCategoria=" + idCategoria + ", codigoAutor=" + codigoAutor + '}';
    }
    ...
    public boolean guardarLibro() {
        ...
        String sql = "INSERT INTO libros\n"
                + "(isbn, nombre, numeroDePaginas, annio, idCategoria, codigoAutor)\n"
                + "VALUES('" + this.isbn + "', '" + this.nombre + "', " + this.numeroDePaginas
                + ", " + this.annio + ", " + this.idCategoria + ", '" + this.codigoAutor + "');";
    ...
    public boolean actualizarLibro() {
        ...
        String sql = "UPDATE libros\n"
                ...
                + ", annio=" + this.annio + ", idCategoria=" + this.idCategoria + ", codigoAutor='" + this.codigoAutor + "'\n"
